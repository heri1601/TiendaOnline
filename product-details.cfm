                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <cfset myImage=ImageNew("#Request.producto.TPR_IMAGEN[1]#")> 
                                            <cfimage source="#myImage#" action="writeToBrowser" class="img-fluid" alt="slide" >
                                        <!---</a>--->
                                    </div>
                                    <!---
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">$#Request.producto.TPR_PRECIO[1]#</p>
                                <a href="product-details.html">
                                    <h6>#Request.producto.TPR_NOMBRE[1]#</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="short_overview my-5">
                                <p>#Request.producto.TPR_DESCRIPCION[1]#</p>
                            </div>
                            

                            <!-- Add to Cart Form -->
                            <form class="cart clearfix" method="post" action="javascript:addToCart(#Request.producto.TPR_PK_PRODUCTO[1]#);">
                                <div class="cart-btn d-flex mb-50">
                                    <p>Qty</p>
                                    <div class="quantity">
                                        <!---<span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i class="fa fa-caret-down" aria-hidden="true"></i></span>--->
                                        <input type="number" disabled class="qty-text" id="qty" step="1" min="1" max="300" name="quantity" value="1">
