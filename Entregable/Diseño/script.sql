...
CREATE TABLE T_SUB_CATEGORIAS
(
  TSC_PK_SUBCATEGORIA  NUMBER(10),
  TCS_FK_CATEGORIA     NUMBER(10),
  TCS_NOMBRE           VARCHAR2(400 BYTE),
  TCS_DESCRIPCION      VARCHAR2(4000 BYTE),
  TCS_FK_ESTADO        NUMBER(10),
  CONSTRAINT T_SUB_CATEGORIAS_PK
  PRIMARY KEY
  (TSC_PK_SUBCATEGORIA)
  ENABLE VALIDATE,
  CONSTRAINT T_SUB_CATEGORIAS_R01 
  FOREIGN KEY (TCS_FK_CATEGORIA) 
  REFERENCES C_CATEGORIAS (CCA_PK_CATEGORIA)
  ENABLE VALIDATE,
  CONSTRAINT T_SUB_CATEGORIAS_R02 
  FOREIGN KEY (TCS_FK_ESTADO) 
  REFERENCES C_ESTADOS_REGISTROS (CES_PK_ESTADO)
  ENABLE VALIDATE
);
...
CREATE TABLE T_SUBCATEGORIAS_PRODUCTOS
(
  TSP_PK_SUBCATE_PROD  NUMBER(10),
  TSP_FK_SUBCATEGORIA  NUMBER(10),
  TSP_FK_PRODUCTO      NUMBER(10),
  TSP_FK_ESTADO        NUMBER(10),
  CONSTRAINT T_SUBCATEGORIAS_PRODUCTOS_PK
  PRIMARY KEY
  (TSP_PK_SUBCATE_PROD)
  ENABLE VALIDATE,
  CONSTRAINT T_SUBCATEGORIAS_PRODUCTOS_R01 
  FOREIGN KEY (TSP_FK_SUBCATEGORIA) 
  REFERENCES T_SUB_CATEGORIAS (TSC_PK_SUBCATEGORIA)
  ENABLE VALIDATE,
  CONSTRAINT T_SUBCATEGORIAS_PRODUCTOS_R02 
  FOREIGN KEY (TSP_FK_PRODUCTO) 
  REFERENCES T_PRODUCTOS (TPR_PK_PRODUCTO)
  ENABLE VALIDATE,
  CONSTRAINT T_SUBCATEGORIAS_PRODUCTOS_R03 
  FOREIGN KEY (TSP_FK_ESTADO) 
  REFERENCES C_ESTADOS_REGISTROS (CES_PK_ESTADO)
  ENABLE VALIDATE
);
